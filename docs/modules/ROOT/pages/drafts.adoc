...
All draft contracts were either moved into a different directory or removed from the Shared AppGara Contracts library on the https://forum.openzeppelin.com/t/openzeppelin-contracts-v3-0-beta-release/2256[v3.0.0 release].
...
* `TokenVesting`: removed. Pending a replacement that is being discussed in https://github.com/appgara/shared-agr-contracts/issues/1214[`#1214`].
...
Removed contracts are still available on the v2.5 release of Shared AppGara Contracts, which you can install by running:
