 ...
 * https://github.com/appgara/shared-agr-contracts/tree/master/audit[Audited] by leading security firms (_last full audit on v2.0.0_).
...
Shared AppGara Contracts features a xref:releases-stability.adoc#api-stability[stable API], which means your contracts won't break unexpectedly when upgrading to a newer minor version.
...
The guides in the sidebar will teach about different concepts, and how to use the related contracts that Shared AppGara Contracts provides:
